...
export type Voice = 'sopran' | 'sopran1' | 'sopran2' | 'alto' | 'tenor' | 'bas' | 'toate' | 'negativ';
...
export const songs: Song[] = [
  ...
  { id: 'cantec-17', title: 'Final: Aleluia', composer: 'G. F. Händel', lang: 'RO', hasScore: true, voices: ['sopran', 'alto', 'tenor', 'bas', 'toate', 'negativ'] }
];
