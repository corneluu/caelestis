...
export const songs: Song[] = [
  ...
  { id: 'cantec-2', title: 'Ave Verum', composer: 'W. A. Mozart', lang: 'LA', hasScore: true, voices: ['sopran', 'alto', 'tenor', 'bas'] },
  ...
  { id: 'cantec-7', title: 'Kyrie: Missa Încoronării', composer: 'W. A. Mozart', lang: 'LA', hasScore: true, voices: ['sopran', 'alto', 'tenor', 'bas'] },
  { id: 'cantec-8', title: 'Gloria (doar refren)', composer: 'Vivaldi', lang: 'LA', hasScore: true, voices: ['sopran', 'alto', 'tenor', 'bas'] },
  { id: 'cantec-9', title: 'Aleluia', composer: 'C. Tocănel', lang: 'RO', hasScore: true, voices: ['sopran', 'alto', 'tenor', 'bas'] },
  { id: 'cantec-10', title: 'Ofertoriu: Tota Pulchra', composer: '', lang: 'LA', hasScore: true, voices: ['sopran', 'alto', 'tenor', 'bas'] },
